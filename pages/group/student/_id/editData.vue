<template>
  ...
  <div class="ourStudentPanel" ref="editDataPanel">
    <div class="container">
       <form action="#" enctype="application/x-www-form-urlencoded" method="post" @submit.prevent="saveChanges">
    ...
    <button name="closeTheDataPanel" @click="router.go(-1)"><img class="closeThePanel" /></button>
    <!-- <button name="closeTheDataPanel" @click="router.go(-1)"><img class="closeThePanel" src="@/assets/images/eXit.png"/></button> -->
...
import{ useRoute, useRouter, ref, useContext, useFetch } from "@nuxtjs/composition-api";
export default {
  name: 'EditData',
  mixins: [dataService],
  setup(_, { emit }){
    ...
    // const student = route.value.params.student;
...
const student = ref("");
    ...
    // const student = ref(Object.assign({}, route.params)).value
    
    // delete student.marks
    // delete student.weights
    // delete student.descriptions
